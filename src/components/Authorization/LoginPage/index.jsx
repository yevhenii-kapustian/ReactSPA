    ...
    return(
        <div className={styles.authorization}>
            <div className={styles.authorizationImage}>
                ...
                <img src={getImgUrl("login.png")} alt="login" height={700}/>
            </div>
            <div className={styles.authorizationMain}>
                <div className={styles.authorizationTitle}>
                    ...
                    <div className={styles.authorizationSwitchButtons}>
                        <button onClick={() => handleCurrentPage("Login")} className={styles.active}>Login</button>
                        <button onClick={() => handleCurrentPage("SignUp")} className={styles.inactive}>Sign Up</button>
                    </div>
                </div>
                <div className={styles.authorizationForm}>
                    ...
                    <form action="#">
                        ...
                        <div className={styles.authorizationFormDetails}> 
                            <label>
                                <input type="checkbox"/>
                                Remember me
                            </label>
